...
import type { SpectatorStateUpdate, ReplayStateItem, SpectatorStateDiff, ClientCombatState, 
    ClientEvent, ClientPlayer, ClientZone, ReplayCardData, ClientCard, EntityId, ClientGameState } from '@/types';
