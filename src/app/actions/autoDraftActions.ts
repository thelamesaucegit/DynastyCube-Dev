      ...
      if (entry.card_pool_id) {
          ...
          if (cardData) {
            queue.push({
              ...
              imageUrl: cardData.image_url ?? undefined,
              oldest_image_url: cardData.oldest_image_url ?? undefined,
    ...
    if (queue.length < limit) {
      ...
      for (const { card } of remainingCards) {
        ...
        queue.push({
          ...
          cubucksCost: card.cubucks_cost ?? undefined,
          cubecobraElo: card.cubecobra_elo ?? undefined,
        });
      }
    }
