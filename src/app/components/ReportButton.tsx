...
export const ReportButton: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* THE FIX: Absolute viewport lock centered cleanly on both Desktop & Mobile */}
      {isOpen && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[1050] overflow-y-auto animate-in fade-in duration-200">
          <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl scale-in duration-200">
            {/* Header */}
