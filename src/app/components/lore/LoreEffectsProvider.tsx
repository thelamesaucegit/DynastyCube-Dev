...
const GlobalCardCorruption = () => {
    ...
    useEffect(() => {
        ...
        const handleMouseOver = (e: MouseEvent) => {
            ...
            if (imageContainer) {
                ...
                if (KEYWORD_REGEX.test(cardName)) {
                    ...
                    console.log(`[LoreProvider] 🎯 Hovered "${cardName}". Rect dimensions:`, {
        ...
        const handleMouseOut = (e: MouseEvent) => {
            if (targetElement) {
                // Determine what element stole the mouse!
                console.log(`[LoreProvider] ❌ MouseOut triggered. Overlay unmounted. Moved to:`, (e.relatedTarget as HTMLElement)?.tagName);
    ...
    return (
        <div
            ...
            style={{
                ...
                // THE FIX: Added a bright red border to prove where it's rendering
                border: '4px solid red', 
                // THE FIX: Removed the clipPath so the entire image covers the card
