...
export const KEYWORD_REGEX = /\b(time|timezone|timeline|timed|timer|temporary|temporal|pause|paused|hourglass|timing|timepiece|clock|clocked|clockwork|hour|minute|era|age|timetwister|timewalk|aeon|eon|moment|ticking|tock)s?\b/gi;
