...
export const KEYWORD_REGEX = /\b(time|timezone|timed|timer|timing|clock|clocked|clockwork|hour|minute|era|age|timetwister|timewalk|aeon|eon|moment|tick|tock)s?\b/gi;
