...
type LoginProvider = "discord" | "google" | null;
...
const DiscordLogin: React.FC = () => {
  ...
  const handleDiscordLogin = async (): Promise<void> => {
    ...
    try {
      ...
      if (authError) {
        setError({
          message: authError.message || "Failed to connect to Discord",
          provider: "discord",
        });
        setLoading(null);
      }
  ...
  const handleGoogleLogin = async (): Promise<void> => {
    ...
    try {
      ...
      if (authError) {
        setError({
          message: authError.message || "Failed to connect to Google",
          provider: "google",
        });
        setLoading(null);
      }
    ...
    <div className="discord-login">
      <div className="login-card">
        ...
        <div className="login-footer">
          <p>By signing in, you agree to participate in The Dynasty Cube community.</p>
        </div>
      </div>
    </div>
  );
