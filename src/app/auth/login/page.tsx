...
// --- THE FIX: Wrap search parameter access inside a nested Suspenseful component! ---
function LoginContent() {
  const [loading, setLoading] = useState(false);
  const [message, setMessage] = useState("");
  const { signInWithDiscord, signInWithGoogle } = useAuth();
  
  // Now safely read search parameters client-side
  ...
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        {/* Nested LoginContent inside a Suspense boundary to pass static optimization */}
        <Suspense fallback={
