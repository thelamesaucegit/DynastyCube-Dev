...
export default function ChamberPoolsPage() {
  ...
  const loadPoolData = async () => {
    ...
    try {
      ...
      console.error("Error loading The Chamber's pool data:", err);
      setError("Failed to load The Chamber's card pool");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
        <div className="container max-w-7xl mx-auto px-4 py-8">
            <div className="flex flex-col items-center justify-center py-20">
                ...
                <p className="text-muted-foreground">Loading The Chamber...</p>
            </div>
        </div>
    );
  }
